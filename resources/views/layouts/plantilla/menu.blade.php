<div class="main-menu menu-fixed menu-dark menu-accordion menu-shadow" data-scroll-to-active="true">
    ...
    <div class="main-menu-content">
        <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
            ...
            <li class=" navigation-header"><span data-i18n="Apps &amp; Pages">ALMACEN</span><i data-feather="more-horizontal"></i>
            </li>
            ...
            <li class=" nav-item"><a class="d-flex align-items-center" href="#"><i data-feather="slack"></i><span class="menu-title text-truncate" data-i18n="Invoice">Almacen</span></a>
                <ul class="menu-content">
                    <li><a class="d-flex align-items-center" href="app-invoice-list.html"><i data-feather="codepen"></i><span class="menu-item text-truncate" data-i18n="List">Categoria</span></a>
                    </li>
                    <li><a class="d-flex align-items-center" href="app-invoice-preview.html"><i data-feather="codepen"></i><span class="menu-item text-truncate" data-i18n="Preview">Articulo</span></a>
                    </li>
                </ul>
                ...
                <li class=" nav-item"><a class="d-flex align-items-center" href="#"><i data-feather="figma"></i><span class="menu-title text-truncate" data-i18n="Invoice">Seguridad</span></a>
                <ul class="menu-content">
                    <li><a class="d-flex align-items-center" href="app-invoice-list.html"><i data-feather="triangle"></i><span class="menu-item text-truncate" data-i18n="List">Categoria</span></a>
                    </li>
                    <li><a class="d-flex align-items-center" href="app-invoice-preview.html"><i data-feather="triangle"></i><span class="menu-item text-truncate" data-i18n="Preview">Articulo</span></a>
                    </li>
